  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-white shadow-md ${isSidebarOpen ? 'hidden' : ''}`}
      >
      ...
      `}>
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center gap-3 mb-6">
            ...
            <Link to="/" className="text-xl font-bold text-gray-900">DemiChatbot</Link>
          </div>
        ...
        <div className={`relative flex items-end w-full bg-white rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.05)] border transition-all duration-200 ${
          ...
          >
            <svg
              ...
              className="w-5 h-5"
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5L19.5 12L4.5 4.5V10.5L14.5 12L4.5 13.5V19.5Z" />
            </svg>
          </button>
        </div>
